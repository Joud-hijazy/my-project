...
const T: Record<string, Record<Lang, string>> = {
  ...
  'vfy.qr.label':    { ar: 'امسح للتحقق',                                     en: 'Scan to verify' },
  ...
  'rr.f.email':         { ar: 'البريد الإلكتروني لصاحب الحق',       en: 'Right Holder Email' },
  'rr.ph.email':        { ar: 'example@domain.com',                  en: 'example@domain.com' },
  'rr.f.desc':          { ar: 'وصف الحق',                           en: 'Right Description' },
  'rr.optional':        { ar: '(اختياري)',                           en: '(optional)' },
  'rr.extra.copyright': { ar: 'معلومات حقوق النشر',                 en: 'Copyright Details' },
  'rr.extra.trademark': { ar: 'معلومات العلامة التجارية',            en: 'Trademark Details' },
  'rr.extra.patent':    { ar: 'معلومات براءة الاختراع',              en: 'Patent Details' },
  'rr.f.work_type':     { ar: 'نوع العمل الإبداعي',                  en: 'Work Type' },
  'rr.ph.work_type':    { ar: 'اختر نوع العمل',                      en: 'Select work type' },
  'rr.f.pub_date':      { ar: 'تاريخ النشر',                         en: 'Publication Date' },
  'rr.f.nice_class':    { ar: 'تصنيف نيس (Nice Class)',              en: 'Nice Classification' },
  'rr.ph.nice_class':   { ar: 'مثال: 25 (ملابس)، 9 (برمجيات)...',   en: 'e.g. 25 (clothing), 9 (software)...' },
  'rr.f.logo_desc':     { ar: 'وصف الشعار',                          en: 'Logo Description' },
  'rr.ph.logo_desc':    { ar: 'وصف مختصر لشكل ومكونات الشعار',       en: 'Brief description of the logo design' },
  'rr.f.tech_field':    { ar: 'المجال التقني',                       en: 'Technical Field' },
  'rr.ph.tech_field':   { ar: 'مثال: الذكاء الاصطناعي، الطاقة...',  en: 'e.g. AI, Energy, Biotech...' },
  'rr.f.inventors':     { ar: 'أسماء المخترعين',                     en: 'Inventors' },
  'rr.ph.inventors':    { ar: 'الاسم الكامل، افصل بفاصلة',           en: 'Full names, comma separated' },
  'rr.f.claims':        { ar: 'مطالبات الاختراع (Claims)',           en: 'Patent Claims' },
  'rr.ph.claims':       { ar: 'صف مطالبات الحماية المطلوبة...',      en: 'Describe the claimed protection scope...' },
